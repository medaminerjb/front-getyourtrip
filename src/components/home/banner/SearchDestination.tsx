...
const locations = [
  { id: 1, City: "Tunisie", Name: "tunis", Code: 50 },
  { id: 2, City: "Tunisie", Name: "tunis1", Code: 50 },
  { id: 3, City: "Tunisie", Name: "tunis2", Code: 50 },
  { id: 4, City: "Tunisie", Name: "tunis3", Code: 50 },
  { id: 5, City: "Tunisie", Name: "tunis4", Code: 50 },
];

const SearchDestination: React.FC<LocationsProps> = ({ onSelect }) => {
