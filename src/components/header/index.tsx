  ...
  return (
     <header className="header-area style-2">
        <div className="header-logo">
            <a href="index.html"><img alt="image" className="img-fluid" src="/assets/img/logo2.svg"/></a>
        </div>
        <div className="main-menu">
            <div className="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div className="mobile-logo-wrap">
                    <a href="index.html"><img alt="image" src="/assets/img/logo2.svg"/></a>
                </div>
            ...
            <ul className="menu-list">
                <li className="menu-item-has-children active">
                    ...
                    <ul className="sub-menu">
                        ...
                        <li className="active"><a href="index2.html">Home 02</a></li>
                ...
                <li>
                    <a href="about.html" className="drop-down">About</a>
                </li>
                <li className="menu-item-has-children">
                    <a href="package-grid.html" className="drop-down">Tours</a><i className="bi bi-plus dropdown-icon"></i>
                    <ul className="sub-menu">
                ...
                <li className="menu-item-has-children">
                    <a href="destination1.html" className="drop-down">Destination</a><i className="bi bi-plus dropdown-icon"></i>
                    <ul className="sub-menu">
                ...
                <li className="menu-item-has-children">
                    <a href="#" className="drop-down">Pages</a><i className="bi bi-plus dropdown-icon"></i>
                    <ul className="sub-menu">
                ...
                <li>
                    <a href="contact.html" className="drop-down">Contact</a>
                </li>
